...
pub const cc = @cImport({
    @cInclude("microui.h");
    @cInclude("string.h");
});

pub const white: u32 = cc.MU_ICON_MAX;
pub const font: u32 = white + 1;
pub const width = 128;
pub const height = 128;
pub const texture = T_T: {
    const txt = [_]u8 {
...
0x00, 0x00, 0xba, 0xf7, 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    const ret = txt ++ [_]u8{0} ** (width * height - txt.len);
    break :T_T ret;
};

inline fn rect(x:i32,y:i32,w:i32,h:i32) cc.mu_Rect {
    return .{.x=x, .y=y, .w=w, .h=h};
}
pub const atlas = T_T: {
    var ret = [_]cc.mu_Rect{.{.x=0,.y=0,.w=0,.h=0}} ** (font + 128);
    ret[cc.MU_ICON_MAX] = rect(88, 68, 16, 16);
    ret[cc.MU_ICON_CLOSE] = rect(88, 68, 16, 16);
    ret[cc.MU_ICON_CHECK] = rect(0, 0, 18, 18);
    ret[cc.MU_ICON_EXPANDED] = rect(118, 68, 7, 5);
    ret[cc.MU_ICON_COLLAPSED] = rect(113, 68, 5, 7);
    ret[white] = rect(125, 68, 3, 3);
    ret[font+32] = rect(84, 68, 2, 17);
    ret[font+33] = rect(39, 68, 3, 17);
    ret[font+34] = rect(114, 51, 5, 17);
    ret[font+35] = rect(34, 17, 7, 17);
    ret[font+36] = rect(28, 34, 6, 17);
    ret[font+37] = rect(58, 0, 9, 17);
    ret[font+38] = rect(103, 0, 8, 17);
    ret[font+39] = rect(86, 68, 2, 17);
    ret[font+40] = rect(42, 68, 3, 17);
    ret[font+41] = rect(45, 68, 3, 17);
    ret[font+42] = rect(34, 34, 6, 17);
    ret[font+43] = rect(40, 34, 6, 17);
    ret[font+44] = rect(48, 68, 3, 17);
    ret[font+45] = rect(51, 68, 3, 17);
    ret[font+46] = rect(54, 68, 3, 17);
    ret[font+47] = rect(124, 34, 4, 17);
    ret[font+48] = rect(46, 34, 6, 17);
    ret[font+49] = rect(52, 34, 6, 17);
    ret[font+50] = rect(58, 34, 6, 17);
    ret[font+51] = rect(64, 34, 6, 17);
    ret[font+52] = rect(70, 34, 6, 17);
    ret[font+53] = rect(76, 34, 6, 17);
    ret[font+54] = rect(82, 34, 6, 17);
    ret[font+55] = rect(88, 34, 6, 17);
    ret[font+56] = rect(94, 34, 6, 17);
    ret[font+57] = rect(100, 34, 6, 17);
    ret[font+58] = rect(57, 68, 3, 17);
    ret[font+59] = rect(60, 68, 3, 17);
    ret[font+60] = rect(106, 34, 6, 17);
    ret[font+61] = rect(112, 34, 6, 17);
    ret[font+62] = rect(118, 34, 6, 17);
    ret[font+63] = rect(119, 51, 5, 17);
    ret[font+64] = rect(18, 0, 10, 17);
    ret[font+65] = rect(41, 17, 7, 17);
    ret[font+66] = rect(48, 17, 7, 17);
    ret[font+67] = rect(55, 17, 7, 17);
    ret[font+68] = rect(111, 0, 8, 17);
    ret[font+69] = rect(0, 35, 6, 17);
    ret[font+70] = rect(6, 35, 6, 17);
    ret[font+71] = rect(119, 0, 8, 17);
    ret[font+72] = rect(18, 17, 8, 17);
    ret[font+73] = rect(63, 68, 3, 17);
    ret[font+74] = rect(66, 68, 3, 17);
    ret[font+75] = rect(62, 17, 7, 17);
    ret[font+76] = rect(12, 51, 6, 17);
    ret[font+77] = rect(28, 0, 10, 17);
    ret[font+78] = rect(67, 0, 9, 17);
    ret[font+79] = rect(76, 0, 9, 17);
    ret[font+80] = rect(69, 17, 7, 17);
    ret[font+81] = rect(85, 0, 9, 17);
    ret[font+82] = rect(76, 17, 7, 17);
    ret[font+83] = rect(18, 51, 6, 17);
    ret[font+84] = rect(24, 51, 6, 17);
    ret[font+85] = rect(26, 17, 8, 17);
    ret[font+86] = rect(83, 17, 7, 17);
    ret[font+87] = rect(38, 0, 10, 17);
    ret[font+88] = rect(90, 17, 7, 17);
    ret[font+89] = rect(30, 51, 6, 17);
    ret[font+90] = rect(36, 51, 6, 17);
    ret[font+91] = rect(69, 68, 3, 17);
    ret[font+92] = rect(124, 51, 4, 17);
    ret[font+93] = rect(72, 68, 3, 17);
    ret[font+94] = rect(42, 51, 6, 17);
    ret[font+95] = rect(15, 68, 4, 17);
    ret[font+96] = rect(48, 51, 6, 17);
    ret[font+97] = rect(54, 51, 6, 17);
    ret[font+98] = rect(97, 17, 7, 17);
    ret[font+99] = rect(0, 52, 5, 17);
    ret[font+100] = rect(104, 17, 7, 17);
    ret[font+101] = rect(60, 51, 6, 17);
    ret[font+102] = rect(19, 68, 4, 17);
    ret[font+103] = rect(66, 51, 6, 17);
    ret[font+104] = rect(111, 17, 7, 17);
    ret[font+105] = rect(75, 68, 3, 17);
    ret[font+106] = rect(78, 68, 3, 17);
    ret[font+107] = rect(72, 51, 6, 17);
    ret[font+108] = rect(81, 68, 3, 17);
    ret[font+109] = rect(48, 0, 10, 17);
    ret[font+110] = rect(118, 17, 7, 17);
    ret[font+111] = rect(0, 18, 7, 17);
    ret[font+112] = rect(7, 18, 7, 17);
    ret[font+113] = rect(14, 34, 7, 17);
    ret[font+114] = rect(23, 68, 4, 17);
    ret[font+115] = rect(5, 52, 5, 17);
    ret[font+116] = rect(27, 68, 4, 17);
    ret[font+117] = rect(21, 34, 7, 17);
    ret[font+118] = rect(78, 51, 6, 17);
    ret[font+119] = rect(94, 0, 9, 17);
    ret[font+120] = rect(84, 51, 6, 17);
    ret[font+121] = rect(90, 51, 6, 17);
    ret[font+122] = rect(10, 68, 5, 17);
    ret[font+123] = rect(31, 68, 4, 17);
    ret[font+124] = rect(96, 51, 6, 17);
    ret[font+125] = rect(35, 68, 4, 17);
    ret[font+126] = rect(102, 51, 6, 17);
    ret[font+127] = rect(108, 51, 6, 17);
    break :T_T ret;
};
